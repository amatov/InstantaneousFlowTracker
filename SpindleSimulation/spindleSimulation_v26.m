...
%--------------------------------------------------------------------------
minPtDist = 5.5;  % Points go within this distance to each other will be merged.
...
magVec = [2.5 0.5];  % First element is mean, second is std
thetaVec = [0 30];     % in degrees. First element is mean. Second is std
