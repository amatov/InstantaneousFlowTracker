...
point_num_dev = 4; % Standard deviation of number of points. (Be conservative and start with 5)

frame_num = 50;       % Number of frames
...
max_new_pt_num = 25;     % maximum number of new points to be generated 
...
%         if (frame_stack(i).coordinate_array(j, 3) == -1)
%             temp_image(temp_center(1) - speckle_size_half : temp_center(1) + speckle_size_half,... 
%             temp_center(2) - speckle_size_half : temp_center(2) + speckle_size_half, 1) = 255;  % use red to represent birth
%         
%             temp_image(temp_center(1) - speckle_size_half : temp_center(1) + speckle_size_half,... 
%             temp_center(2) - speckle_size_half : temp_center(2) + speckle_size_half, 2) = 0;  % use green to represent birth
%         elseif ((i ~= frame_num) & (~ismember(j, frame_stack(i+1).coordinate_array(:,3))))
%             temp_image(temp_center(1) - speckle_size_half : temp_center(1) + speckle_size_half,... 
%             temp_center(2) - speckle_size_half : temp_center(2) + speckle_size_half, 2) = 0;  % use green to represent birth
%             
%             temp_image(temp_center(1) - speckle_size_half : temp_center(1) + speckle_size_half,... 
%             temp_center(2) - speckle_size_half : temp_center(2) + speckle_size_half, 3) = 255;  % use blue to represent death
%         end
%         
    % Generate the point list file first. Then generate the movie, as this video generation can
    % be slow.
