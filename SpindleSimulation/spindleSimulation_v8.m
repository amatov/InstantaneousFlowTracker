...
% approximately the same complexity as that of true images.
...
%     distributions include: uniform, Gaussian, exponential and Poission.
%     Extensions to other distributions are straightforward. 
%     NOTE: the seed for such generation is fixed for repetitiveness!
%
%
%
%
...
% First, generate lifetime array for all tracks (some of them do not exist
% at this point)
