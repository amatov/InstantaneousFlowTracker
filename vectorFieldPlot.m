function h=vectorFieldPlot(F,handle,polygon,scale,colorNumber)
...
%            colorNumber: (optional) if it exist, instead of regular method
%                     for the order of colors, it will use the requested
%                     color to plot.
%
...
if size(F,2)==4
    ...
    if isempty(imgHandle)
        ...
        colorTable={'yellow','red','green','white','magenta'};
    end
