...
#### Examples of published papers, since the summer of 2004 (when I had completed all modules of the software and writing the manuscript), where the Instantaneous Flow Tracker was used:
