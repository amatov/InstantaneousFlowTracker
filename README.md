...
Since the summer of 2004, when I had completed all modules of the software and written the manuscript, the IFTA was applied for data analysis in the following publications:
