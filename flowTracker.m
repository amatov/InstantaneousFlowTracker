...
for j = 1:iterations
    ...
    if nbDir == 1 %2
        [cAdd,w3,cluster_index,bestmu,flowMap,dir] = clusteringWrap(links,nbDir,ve,w3,singleTriplets,RAK_ANGLE); % 2 DIR
    else
        [cAdd,w3,cluster_index,bestmu,flowMap,dir,nbDir] = clusteringKmeans(links,nbDir,ve,w3,singleTriplets); % 3 DIR
    end
